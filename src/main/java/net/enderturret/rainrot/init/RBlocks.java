...
public final class RBlocks {
	...
	public static final Holder<Block> ROTCORN_PLANT = REGISTRY.register("rotcorn_plant", () -> new PopcornPlantBlock(props().sound(SoundType.AZALEA_LEAVES).strength(0.2F), RainRotCommonConfig::spoilWatcher));
	...
	public static final Holder<Block> FIVE_PEBBLES_PLUSH = REGISTRY.register("five_pebbles_plush", () -> new IteratorPlushieBlock(plush(MapColor.COLOR_PINK), RainRotCommonConfig::spoilBaseGame));
	public static final Holder<Block> LOOKS_TO_THE_MOON_PLUSH = REGISTRY.register("looks_to_the_moon_plush", () -> new IteratorPlushieBlock(plush(MapColor.COLOR_LIGHT_BLUE), RainRotCommonConfig::spoilBaseGame));
	public static final Holder<Block> NO_SIGNIFICANT_HARASSMENT_PLUSH = REGISTRY.register("no_significant_harassment_plush", () -> new IteratorPlushieBlock(plush(MapColor.COLOR_GREEN), RainRotCommonConfig::spoilHunter));
	public static final Holder<Block> SEVEN_RED_SUNS_PLUSH = REGISTRY.register("seven_red_suns_plush", () -> new IteratorPlushieBlock(plush(MapColor.COLOR_ORANGE), RainRotCommonConfig::spoilSpearmaster));
	public static final Holder<Block> SLIVER_OF_STRAW_PLUSH = REGISTRY.register("sliver_of_straw_plush", () -> new IteratorPlushieBlock(plush(MapColor.TERRACOTTA_WHITE), RainRotCommonConfig::spoilChallenge70));
