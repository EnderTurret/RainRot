...
public final class RTab {
	...
	public static final Holder<CreativeModeTab> INSTANCE = REGISTRY.register("tab", () -> CreativeModeTab.builder().title(Component.translatable("itemGroup.rainrot"))
			...
			.displayItems((params, output) -> {
				...
				addAll(output, POPCORN_SEEDS, RBlocks.POPCORN_PLANT, ROTCORN_SEEDS, RBlocks.ROTCORN_PLANT, BUBBLEFRUIT, POPPED_BUBBLEFRUIT);
				...
				addAll(output, RBlocks.FIVE_PEBBSI_VENDING_MACHINE, RBlocks.FLUX_CONDENSER, RBlocks.TUNNEL);
